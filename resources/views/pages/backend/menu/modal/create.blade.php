    ...
    <div class="modal-body" id="modalCenterLargeContent">
        <div class="row g-3">
            ...
            <div class="col-lg-8 col-md-6 col-sm-12 col-xs-12">
                <input type="text" class="form-control" name="nama" id="nama" value="" placeholder="Masukkan Nama" required>
            ...
            <div class="col-lg-8 col-md-6 col-sm-12 col-xs-12">
                <input type="text" class="form-control" name="icon" id="icon" value="" placeholder="Masukkan Icon (Ex: fas fa-users-cog )" required>
            ...
            <div class="col-lg-8 col-md-6 col-sm-12 col-xs-12">
                <input type="number" class="form-control" name="ordinalNumber" id="ordinalNumber" value="0" min="0" max="999" placeholder="Masukkan Nomer Urutan" required>
            ...
            <div class="col-lg-8 col-md-6 col-sm-12 col-xs-12">
                <select class="form-control" id="tipeMenu" name="tipeMenu" required>
                    ...
                    @foreach ($tipeMenus as $tipeMenu)
                        <option value="{{$tipeMenu}}">{{$tipeMenu}}</option>
                    @endforeach
                </select>
