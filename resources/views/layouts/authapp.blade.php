...
<html lang="en">
    ...
    <head>
        ...
        <meta charset="utf-8" />
        <title>E-Perpustkaan | @yield('title')</title>
                                ...
                                <div class="d-flex flex-column h-100">
                                    <div class=" text-center">
                                        <a href="index.html" class="d-block auth-logo">
                                            <img src="{{asset('logo/logo_kabupaten_tolitoli.png')}}" alt="" height="80">
                                    </div>
                                    <div class="mb-4 mb-md-5 text-center">
                                        <a href="index.html" class="d-block auth-logo">
                                            <span class="logo-txt">Kabupaten Tolitoli</span>
                                        </a>
                                    </div>
                                    ...
                                    <div class="mt-4 mt-md-5 text-center">
                                        <p class="mb-0">© <script>document.write(new Date().getFullYear())</script> E-Perpustakaan. Crafted with <i class="mdi mdi-heart text-danger"></i> by TATI</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                                                        ...
                                                        <div class="mt-4 pt-3 pb-5">
                                                            <div class="d-flex align-items-start">
                                                                <div class="flex-shrink-0">
                                                                    <img src="{{ asset('/') }}admin_assets/images/users/avatar-1.jpg" class="avatar-md img-fluid rounded-circle" alt="...">
                                                                </div>
                                                ...
                                                <div class="carousel-item">
                                                    <div class="testi-contain text-white">
                                                        ...
                                                        <div class="mt-4 pt-3 pb-5">
                                                            <div class="d-flex align-items-start">
                                                                <div class="flex-shrink-0">
                                                                    <img src="{{ asset('/') }}admin_assets/images/users/avatar-2.jpg" class="avatar-md img-fluid rounded-circle" alt="...">
                                                                </div>
                                                                <div class="flex-grow-1 ms-3 mb-4">
