<form class="form" id="form_edit" enctype="multipart/form-data">
    ...
    <div class="modal-body" id="modalCenterContent">
        <input type="hidden" class="form-control" name="id" id="id" value="{{encrypt($rak->id)}}" placeholder="" required>
        <div class="row g-3">
            ...
            <div class="col-lg-8 col-md-6 col-sm-12 col-xs-12">
                <input type="text" class="form-control" name="kode" id="kode" value="{{$rak->kode}}" placeholder="Masukkan Kode" required>
            ...
            <div class="col-lg-8 col-md-6 col-sm-12 col-xs-12">
                <input type="checkbox" id="switch1" name="isActive" switch="none" {{$rak->is_active ? 'checked' : ''}} />
