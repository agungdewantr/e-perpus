<form class="form" id="form_edit_rellarphp" enctype="multipart/form-data">
    ...
    <div class="modal-body" id="modalCenterLargeContent">
        <div class="row g-3">
            <input type="text" class="form-control" name="id" id="id" value="{{encrypt($profilPetugas->id)}}" readonly hidden>
            <div class="col-lg-4 col-md-6 col-sm-12 col-xs-12">
                <label for="nip" class="form-label">NIP</label>
            </div>
            <div class="col-lg-8 col-md-6 col-sm-12 col-xs-12">
                <input type="text" class="form-control" name="nip" id="nip" value="{{$profilPetugas->nip ?? null}}" placeholder="Masukkan NIP">
            ...
            <div class="col-lg-8 col-md-6 col-sm-12 col-xs-12">
                <input type="text" class="form-control" name="nama_lengkap" id="nama_lengkap" value="{{$profilPetugas->nama_lengkap ?? null}}" placeholder="Masukkan Nama Lengkap" required>
            ...
            <div class="col-lg-8 col-md-6 col-sm-12 col-xs-12">
                <input type="text" class="form-control" name="nomor_telepon" id="nomor_telepon" value="{{$profilPetugas->nomor_telepon ?? null}}" placeholder="Masukkan Nomor Telepon" required>
            ...
            <div class="col-lg-8 col-md-6 col-sm-12 col-xs-12">
                <div class="row">
                    <div class="col-lg-6 col-sm-12">
                        <input type="time" class="form-control" name="jadwal_shift_mulai" id="jadwal_shift_mulai" value="{{ \Carbon\Carbon::parse($profilPetugas->jadwal_shift_mulai ?? null)->format('H:i') }}" required>
                        <small class="validation-jadwal_shift_mulai text-danger"></small>
                    </div>
                    <div class="col-lg-6 col-sm-12">
                        <input type="time" class="form-control" name="jadwal_shift_selesai" id="jadwal_shift_selesai" value="{{ \Carbon\Carbon::parse($profilPetugas->jadwal_shift_selesai ?? null)->format('H:i') }}" required>
            ...
            <div class="col-lg-8 col-md-6 col-sm-12 col-xs-12">
                <input type="text" class="form-control" name="username" id="username" value="{{$profilPetugas->user->username ?? null}}" placeholder="Masukkan Username" disabled style="background-color: #f8f9fa;">
            ...
            <div class="col-lg-8 col-md-6 col-sm-12 col-xs-12">
                <input type="email" class="form-control" name="email" id="email" value="{{$profilPetugas->user->email ?? null}}" placeholder="Masukkan Email">
            ...
            <div class="col-lg-8 col-md-6 col-sm-12 col-xs-12">
                ...
                <div class="validation-password text-danger">
                    <small class="text-muted">Minimal 8 Karakter kombinasi huruf kapital, huruf kecil, angka dan simbol(@$!#%*?&).</small><br>
                    <small class="text-danger">Jika password tidak diganti, kosongkan saja.</small>
                </div>
            </div>
            ...
            <div class="col-lg-8 col-md-6 col-sm-12 col-xs-12">
                <input type="checkbox" id="switch1" name="isActive" switch="none" {{$profilPetugas->user->is_active ? 'checked' : ''}} />
