    ...
    <div class="modal-body" id="modalCenterContent">
        <div class="row g-3">
            ...
            <div class="col-lg-8 col-md-6 col-sm-12 col-xs-12">
                <input type="text" class="form-control" name="nama" id="nama" value="" placeholder="Masukkan Pengadaan" required>
            ...
            <div class="col-lg-8 col-md-6 col-sm-12 col-xs-12">
                <input type="text" class="form-control" name="keterangan" id="keterangan" value="" placeholder="Masukkan Keterangan" required>
