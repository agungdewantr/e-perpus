<div class="modal-body">
    <div class="row">
        ...
        <div class="col-11">
            <span class="">
                Sebelum melakukan import kunjungan perpustakaan menggunakan file excel, silahkan mengunduh template  melalui tombol berikut :
            </span>
            <br>
            <br>
            <form action="{{route('kunjunganperpustakaan.downloadtemplate')}}">
...
<div class="modal-footer mt-2">
    ...
    <button type="submit" class="btn btn-sm btn-success waves-effect text-left" onclick="lanjut('Kunjungan Perpustakaan')">
...
<script>
    ...
    function lanjut(param){
        ...
        $('#form_tambah').on('submit', function(event) {
            ...
            $.ajax({
                type: "POST",
                url: "{{route('kunjunganperpustakaan.importexcel')}}",
                data: idata,
                processData: false,
                contentType: false,
                cache: false,
