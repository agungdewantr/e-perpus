    ...
    <div class="navbar-header">
        <div class="d-flex">
            ...
            <div class="navbar-brand-box">
                <a href="{{ route('dashboard') }}" class="logo logo-dark">
                    <span class="logo-sm">
                        <img src="{{ asset('/') }}web_assets/images/logo-mini.png" alt="" height="24">
                    </span>
                    <span class="logo-lg">
                        <img src="{{ asset('/') }}web_assets/images/logo-dark.png" alt="" height="24">
                    </span>
                </a>
                ...
                <a href="{{ route('dashboard') }}" class="logo logo-light">
                    ...
                    <span class="logo-lg">
                        <img src="{{ asset('/') }}web_assets/images/logo-light.png" alt="" height="24">
                    </span>
                </a>
            </div>
        ...
        <div class="d-flex">
            ...
            {{-- <div class="dropdown d-none d-sm-inline-block">
                ...
                data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <img id="header-lang-img" src="{{ asset('/') }}admin_assets/images/flags/us.jpg" alt="Header Language" height="16">
                </button>
                <div class="dropdown-menu dropdown-menu-end">

                    <!-- item-->
                    <a href="javascript:void(0);" class="dropdown-item notify-item language" data-lang="en">
                        <img src="{{ asset('/') }}admin_assets/images/flags/us.jpg" alt="user-image" class="me-1" height="12"> <span class="align-middle">English</span>
                    </a>
                    <!-- item-->
            ...
            <div class="dropdown d-none d-sm-inline-block">
                <button type="button" class="btn header-item" id="btn-change-theme">
                ...
                <div class="dropdown-menu dropdown-menu-lg dropdown-menu-end p-0"
                    ...
                    <div data-simplebar style="max-height: 230px;">
                        <a href="#!" class="text-reset notification-item">
                            <div class="d-flex">
                                <div class="flex-shrink-0 me-3">
                                    <img src="{{ asset('/') }}admin_assets/images/users/avatar-3.jpg" class="rounded-circle avatar-sm" alt="user-pic">
                                </div>
                        ...
                        <a href="#!" class="text-reset notification-item">
                            <div class="d-flex">
                                <div class="flex-shrink-0 me-3">
                                    <img src="{{ asset('/') }}admin_assets/images/users/avatar-6.jpg" class="rounded-circle avatar-sm" alt="user-pic">
                                </div>
                                <div class="flex-grow-1">
            ...
            <div class="dropdown d-inline-block">
                <button type="button" class="btn header-item topbar-light bg-light-subtle border-start border-end"
                    ...
                    <img class="rounded-circle header-profile-user"
                        src="{{ auth()->user()->foto ? Storage::url(auth()->user()->foto->file_path) : Storage::url('user/default.png') }}"
                        alt="Header Avatar">
                ...
                <div class="dropdown-menu dropdown-menu-end">
                    <!-- item-->
                    <a class="dropdown-item" href="{{ route('profilParam.index', encrypt(auth()->user()->id)) }}"><i
