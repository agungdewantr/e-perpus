...
class NotifikasiPengembalianBukuHMin1 extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'notifikasi-pengembalian-buku-h-min-1';
     ...
     * @var string
     */
    protected $description = 'Push notification pengembalian buku kurang 1 hari lagi.';
    ...
    public function handle()
    {
        ...
        foreach($peminjamans as $peminjaman){
            ...
            $pusher->trigger($peminjaman->profilAnggota->user->id . '-notification', 'notify', [
                ...
                'isi' => 'Peringatan batas pengembalian 1 hari lagi.',
            ...
            $notifikasi->isi = 'Peringatan batas pengembalian 1 hari lagi.';
            $notifikasi->save();
        }
        $this->info('Notifikasi peringatan batas pengembalian 1 hari lagi berhasil dikirim.');    }
}
