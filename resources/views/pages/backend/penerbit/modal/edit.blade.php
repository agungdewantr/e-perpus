<form class="form" id="form_edit" enctype="multipart/form-data">
    ...
    <div class="modal-body" id="modalCenterContent">
        <input type="hidden" class="form-control" name="id" id="id" value="{{encrypt($penerbit->id)}}" placeholder="" required>
        <div class="row g-3">
            ...
            <div class="col-lg-8 col-md-6 col-sm-12 col-xs-12">
                <input type="text" class="form-control" name="namaPenerbit" id="namaPenerbit" value="{{$penerbit->namaPenerbit}}" placeholder="Masukkan Nama Penerbit" required>
            ...
            <div class="col-lg-8 col-md-6 col-sm-12 col-xs-12">
                <input type="checkbox" id="switch1" name="isActive" switch="none" {{$penerbit->is_active ? 'checked' : ''}} />
